...
export const fallbackVocabs: Vocabulary[] = [
  ...
  { id: 'c1_13', chapter_number: 1, category: 'country', word_romaji: 'Tai', word_kana: 'タイ', word_kanji: null, meaning_th: 'ประเทศไทย', example_jp: 'Tai kara kimashita.', example_th: 'มาจากประเทศไทย', textbook_ref: 'JN60101 Ch.1 p.15' },
  { id: 'c1_14', chapter_number: 1, category: 'country', word_romaji: 'Nihon', word_kana: 'にほん', word_kanji: '日本', meaning_th: 'ประเทศญี่ปุ่น', example_jp: 'Nihon kara kimashita.', example_th: 'มาจากประเทศญี่ปุ่น', textbook_ref: 'JN60101 Ch.1 p.16' },
  { id: 'c1_15', chapter_number: 1, category: 'country', word_romaji: 'Amerika', word_kana: 'アメリカ', word_kanji: null, meaning_th: 'ประเทศสหรัฐอเมริกา', example_jp: 'Amerika kara kimashita.', example_th: 'มาจากประเทศอเมริกา', textbook_ref: 'JN60101 Ch.1 p.17' },
  { id: 'c1_16', chapter_number: 1, category: 'country', word_romaji: 'Chūgoku', word_kana: 'ちゅうごく', word_kanji: '中国', meaning_th: 'ประเทศจีน', example_jp: 'Chūgoku kara kimashita.', example_th: 'มาจากประเทศจีน', textbook_ref: 'JN60101 Ch.1 p.18' },
  ...
  { id: 'c1_21', chapter_number: 1, category: 'nationality', word_romaji: 'Nihon-jin', word_kana: 'にほんじん', word_kanji: '日本人', meaning_th: 'คนญี่ปุ่น', example_jp: 'Watashi wa Nihon-jin desu.', example_th: 'ฉันเป็นคนญี่ปุ่น', textbook_ref: 'JN60101 Ch.1 p.16' },
  { id: 'c1_22', chapter_number: 1, category: 'nationality', word_romaji: 'Tai-jin', word_kana: 'タイじん', word_kanji: 'タイ人', meaning_th: 'คนไทย', example_jp: 'Watashi wa Tai-jin desu.', example_th: 'ฉันเป็นคนไทย', textbook_ref: 'JN60101 Ch.1 p.15' },

  // Occupations
  { id: 'c1_23', chapter_number: 1, category: 'occupation', word_romaji: 'sensei', word_kana: 'せんせい', word_kanji: '先生', meaning_th: 'อาจารย์ / ครู', example_jp: 'Anata wa sensei desu.', example_th: 'คุณคืออาจารย์', textbook_ref: 'JN60101 Ch.1 p.8' },
  { id: 'c1_24', chapter_number: 1, category: 'occupation', word_romaji: 'gakusei', word_kana: 'がくせい', word_kanji: '学生', meaning_th: 'นักเรียน / นักศึกษา', example_jp: 'Watashi wa gakusei desu.', example_th: 'ฉันคือนักศึกษา', textbook_ref: 'JN60101 Ch.1 p.9' },
  { id: 'c1_25', chapter_number: 1, category: 'occupation', word_romaji: 'kaishain', word_kana: 'かいしゃいん', word_kanji: '会社員', meaning_th: 'พนักงานบริษัท', example_jp: 'Yamada-san wa kaishain desu.', example_th: 'คุณยามาดะเป็นพนักงานบริษัท', textbook_ref: 'JN60101 Ch.1 p.10' },
  { id: 'c1_26', chapter_number: 1, category: 'occupation', word_romaji: 'ginkōin', word_kana: 'ぎんこういん', word_kanji: '銀行員', meaning_th: 'พนักงานธนาคาร', example_jp: 'Anohito wa ginkōin desu.', example_th: 'คนนั้นคือพนักงานธนาคาร', textbook_ref: 'JN60101 Ch.1 p.11' },
  { id: 'c1_27', chapter_number: 1, category: 'occupation', word_romaji: 'isha', word_kana: 'いしゃ', word_kanji: '医者', meaning_th: 'แพทย์ / คุณหมอ', example_jp: 'Anohito wa isha desu.', example_th: 'คนนั้นคือคุณหมอ', textbook_ref: 'JN60101 Ch.1 p.12' },
  { id: 'c1_28', chapter_number: 1, category: 'occupation', word_romaji: 'hisho', word_kana: 'ひしょ', word_kanji: '秘書', meaning_th: 'เลขานุการ', example_jp: 'Anohito wa hisho desu.', example_th: 'คนนั้นคือเลขานุการ', textbook_ref: 'JN60101 Ch.1 p.12' },
  { id: 'c1_29', chapter_number: 1, category: 'occupation', word_romaji: 'kenkyūsha', word_kana: 'けんきゅうしゃ', word_kanji: '研究者', meaning_th: 'นักวิจัย', example_jp: 'Sumisu-san wa kenkyūsha desu.', example_th: 'คุณสมิธเป็นนักวิจัย', textbook_ref: 'JN60101 Ch.1 p.13' },
  { id: 'c1_30', chapter_number: 1, category: 'occupation', word_romaji: 'bengoshi', word_kana: 'べんごし', word_kanji: '弁護士', meaning_th: 'ทนายความ', example_jp: 'Sumisu-san wa bengoshi desu.', example_th: 'คุณสมิธเป็นทนายความ', textbook_ref: 'JN60101 Ch.1 p.91' },
  { id: 'c1_31', chapter_number: 1, category: 'occupation', word_romaji: 'enjinia', word_kana: 'エンジニア', word_kanji: null, meaning_th: 'วิศวกร', example_jp: 'Anohito wa enjinia desu.', example_th: 'คนนั้นเป็นวิศวกร', textbook_ref: 'JN60101 Ch.1 p.13' },

  // Places & Institutions
  { id: 'c1_32', chapter_number: 1, category: 'place', word_romaji: 'daigaku', word_kana: 'だいがく', word_kanji: '大学', meaning_th: 'มหาวิทยาลัย', example_jp: 'Daigaku no gakusei', example_th: 'นักศึกษามหาวิทยาลัย', textbook_ref: 'JN60101 Ch.1 p.71' },
  ...
  { id: 'c1_34', chapter_number: 1, category: 'place', word_romaji: 'Panyapiwatto keiei daigaku', word_kana: 'パンヤピワットけいえいだいがく', word_kanji: null, meaning_th: 'สถาบันการจัดการปัญญาภิวัฒน์ (PIM)', example_jp: 'Panyapiwatto keiei daigaku no gakusei desu.', example_th: 'เป็นนักศึกษาสถาบันปัญญาภิวัฒน์', textbook_ref: 'JN60101 Ch.1 p.71, 105' },
  { id: 'c1_35', chapter_number: 1, category: 'place', word_romaji: 'byōin', word_kana: 'びょういん', word_kanji: '病院', meaning_th: 'โรงพยาบาล', example_jp: 'Kochira wa byōin desu.', example_th: 'ที่นี่คือโรงพยาบาล', textbook_ref: 'JN60101 Ch.1 p.72' },
  ...
  { id: 'c1_38', chapter_number: 1, category: 'place', word_romaji: 'uketsuke', word_kana: 'うけつけ', word_kanji: '受付', meaning_th: 'แผนกต้อนรับ / ประชาสัมพันธ์', example_jp: 'Kochira wa uketsuke desu.', example_th: 'ที่นี่คือแผนกต้อนรับ', textbook_ref: 'JN60101 Ch.1 p.73' },
  { id: 'c1_39', chapter_number: 1, category: 'place', word_romaji: 'denki', word_kana: 'でんき', word_kanji: '電気', meaning_th: 'ไฟฟ้า / บริษัทไฟฟ้า', example_jp: 'Fuji denki', example_th: 'บริษัท ฟูจิ เดนกิ', textbook_ref: 'JN60101 Ch.1 p.74' },
  { id: 'c1_40', chapter_number: 1, category: 'place', word_romaji: 'ABC fūzu', word_kana: 'ABCフーズ', word_kanji: null, meaning_th: 'บริษัทอาหาร ABC Foods', example_jp: 'ABC fūzu no Sumisu-san', example_th: 'คุณสมิธแห่งบริษัท ABC Foods', textbook_ref: 'JN60101 Ch.1 p.89' },
  { id: 'c1_41', chapter_number: 1, category: 'place', word_romaji: 'Nozomi depāto', word_kana: 'のぞみデパート', word_kanji: null, meaning_th: 'ห้างสรรพสินค้าโนโซมิ (ห้างแห่งความหวัง)', example_jp: 'Nozomi depāto no Takahashi-san', example_th: 'คุณทาคาฮาชิแห่งห้างโนโซมิ', textbook_ref: 'JN60101 Ch.1 p.89' },
  ...
  { id: 'c1_48', chapter_number: 1, category: 'phrase', word_romaji: 'shitsurei desuga', word_kana: 'しつれいですが', word_kanji: '失礼ですが', meaning_th: 'ขอประทานโทษครับแต่ว่า... / เสียมารยาทนะครับแต่...', example_jp: 'Shitsurei desuga, o-namae wa?', example_th: 'ขอโทษนะครับ ขอทราบชื่อหน่อยครับ', textbook_ref: 'JN60101 Ch.1 p.81' },
  { id: 'c1_49', chapter_number: 1, category: 'phrase', word_romaji: 'O-namae wa?', word_kana: 'おなまえは？', word_kanji: 'お名前は？', meaning_th: 'ขอทราบชื่อด้วยครับ / ชื่ออะไรครับ?', example_jp: 'O-namae wa?', example_th: 'ชื่ออะไรครับ?', textbook_ref: 'JN60101 Ch.1 p.82' },
  ...
  { id: 'c1_52', chapter_number: 1, category: 'phrase', word_romaji: 'kochira wa ...-san desu', word_kana: 'こちらは〜さんです', word_kanji: null, meaning_th: 'ทางนี้ / ด้านนี้คือคุณ...', example_jp: 'Kochira wa Takahashi-san desu.', example_th: 'ทางนี้คือคุณทาคาฮาชิครับ', textbook_ref: 'JN60101 Ch.1 p.85' },
  { id: 'c1_53', chapter_number: 1, category: 'phrase', word_romaji: '... kara kimashita', word_kana: '〜からきました', word_kanji: '〜から来ました', meaning_th: 'มาจาก... (ประเทศ/เมือง)', example_jp: 'Tai kara kimashita.', example_th: 'มาจากประเทศไทย', textbook_ref: 'JN60101 Ch.1 p.86' },
  ...
  { id: 'c2_08', chapter_number: 2, category: 'object', word_romaji: 'hon', word_kana: 'ほん', word_kanji: '本', meaning_th: 'หนังสือ', example_jp: 'Kore wa hon desu.', example_th: 'นี่คือหนังสือ', textbook_ref: 'JN60101 Ch.2 p.10' },
  { id: 'c2_09', chapter_number: 2, category: 'object', word_romaji: 'jisho', word_kana: 'じしょ', word_kanji: '辞書', meaning_th: 'พจนานุกรม', example_jp: 'Kore wa jisho desu.', example_th: 'นี่คือพจนานุกรม', textbook_ref: 'JN60101 Ch.2 p.11' },
  { id: 'c2_10', chapter_number: 2, category: 'object', word_romaji: 'zasshi', word_kana: 'ざっし', word_kanji: '雑誌', meaning_th: 'นิตยสาร', example_jp: 'Kore wa nihongo no zasshi desu.', example_th: 'นี่คือนิตยสารภาษาญี่ปุ่น', textbook_ref: 'JN60101 Ch.2 p.12' },
  { id: 'c2_11', chapter_number: 2, category: 'object', word_romaji: 'shinbun', word_kana: 'しんぶん', word_kanji: '新聞', meaning_th: 'หนังสือพิมพ์', example_jp: 'Sore wa shinbun desu.', example_th: 'นั่นคือหนังสือพิมพ์', textbook_ref: 'JN60101 Ch.2 p.13' },
  { id: 'c2_12', chapter_number: 2, category: 'object', word_romaji: 'techō', word_kana: 'てちょう', word_kanji: '手帳', meaning_th: 'สมุดพก / สมุดไดอารี่', example_jp: 'Kore wa techō desu.', example_th: 'นี่คือสมุดพก', textbook_ref: 'JN60101 Ch.2 p.14' },
  { id: 'c2_13', chapter_number: 2, category: 'object', word_romaji: 'meishi', word_kana: 'めいし', word_kanji: '名刺', meaning_th: 'นามบัตร', example_jp: 'Kore wa meishi desu.', example_th: 'นี่คือนามบัตร', textbook_ref: 'JN60101 Ch.2 p.57' },
  { id: 'c2_14', chapter_number: 2, category: 'object', word_romaji: 'enpitsu', word_kana: 'えんぴつ', word_kanji: '鉛筆', meaning_th: 'ดินสอ', example_jp: 'Kore wa enpitsu desu.', example_th: 'นี่คือดินสอ', textbook_ref: 'JN60101 Ch.2 p.16' },
  { id: 'c2_15', chapter_number: 2, category: 'object', word_romaji: 'kagi', word_kana: 'かぎ', word_kanji: '鍵', meaning_th: 'กุญแจ', example_jp: 'Kore wa kagi desu.', example_th: 'นี่คือกุญแจ', textbook_ref: 'JN60101 Ch.2 p.17' },
  { id: 'c2_16', chapter_number: 2, category: 'object', word_romaji: 'tokei', word_kana: 'とけい', word_kanji: '時計', meaning_th: 'นาฬิกา', example_jp: 'Kore wa tokei desu.', example_th: 'นี่คือนาฬิกา', textbook_ref: 'JN60101 Ch.2 p.18' },
  { id: 'c2_17', chapter_number: 2, category: 'object', word_romaji: 'keitai', word_kana: 'けいたい', word_kanji: '携帯', meaning_th: 'โทรศัพท์มือถือ', example_jp: 'Kore wa keitai desu.', example_th: 'นี่คือโทรศัพท์มือถือ', textbook_ref: 'JN60101 Ch.2 p.19' },
  { id: 'c2_18', chapter_number: 2, category: 'object', word_romaji: 'kasa', word_kana: 'かさ', word_kanji: '傘', meaning_th: 'ร่ม', example_jp: 'Kore wa Sasaki-san no kasa desu.', example_th: 'นี่คือร่มของคุณซาซากิ', textbook_ref: 'JN60101 Ch.2 p.20' },
  { id: 'c2_19', chapter_number: 2, category: 'object', word_romaji: 'kaban', word_kana: 'かばん', word_kanji: '鞄', meaning_th: 'กระเป๋า', example_jp: 'Kore wa kaban desu.', example_th: 'นี่คือกระเป๋า', textbook_ref: 'JN60101 Ch.2 p.21' },
  { id: 'c2_20', chapter_number: 2, category: 'object', word_romaji: 'jidōsha', word_kana: 'じどうしゃ', word_kanji: '自動車', meaning_th: 'รถยนต์ (= kuruma)', example_jp: 'Kore wa jidōsha no hon desu.', example_th: 'นี่คือหนังสือเกี่ยวกับรถยนต์', textbook_ref: 'JN60101 Ch.2 p.22' },
  { id: 'c2_21', chapter_number: 2, category: 'object', word_romaji: 'kuruma', word_kana: 'くるま', word_kanji: '車', meaning_th: 'รถยนต์', example_jp: 'Watashi no kuruma', example_th: 'รถยนต์ของฉัน', textbook_ref: 'JN60101 Ch.2 p.22' },
  { id: 'c2_22', chapter_number: 2, category: 'object', word_romaji: 'tsukue', word_kana: 'つくえ', word_kanji: '机', meaning_th: 'โต๊ะทำงาน', example_jp: 'Kore wa tsukue desu.', example_th: 'นี่คือโต๊ะทำงาน', textbook_ref: 'JN60101 Ch.2 p.23' },
  { id: 'c2_23', chapter_number: 2, category: 'object', word_romaji: 'isu', word_kana: 'いす', word_kanji: '椅子', meaning_th: 'เก้าอี้', example_jp: 'Kore wa isu desu.', example_th: 'นี่คือเก้าอี้', textbook_ref: 'JN60101 Ch.2 p.24' },
  ...
  { id: 'c2_30', chapter_number: 2, category: 'place', word_romaji: 'kaisha', word_kana: 'かいしゃ', word_kanji: '会社', meaning_th: 'บริษัท', example_jp: 'ABC kaisha', example_th: 'บริษัท ABC', textbook_ref: 'JN60101 Ch.2 p.77' },

  // Languages (Ch.2)
  { id: 'c2_31', chapter_number: 2, category: 'language', word_romaji: 'Eigo', word_kana: 'えいご', word_kanji: '英語', meaning_th: 'ภาษาอังกฤษ', example_jp: 'Eigo no zasshi', example_th: 'นิตยสารภาษาอังกฤษ', textbook_ref: 'JN60101 Ch.2 p.27' },
  { id: 'c2_32', chapter_number: 2, category: 'language', word_romaji: 'Nihongo', word_kana: 'にほんご', word_kanji: '日本語', meaning_th: 'ภาษาญี่ปุ่น', example_jp: 'Nihongo no hon', example_th: 'หนังสือภาษาญี่ปุ่น', textbook_ref: 'JN60101 Ch.2 p.28' },
  ...
  { id: 'c2_36', chapter_number: 2, category: 'katakana', word_romaji: 'nōto', word_kana: 'ノート', word_kanji: null, meaning_th: 'สมุดจด / สมุดโน้ต', example_jp: 'Kore wa nōto desu.', example_th: 'นี่คือสมุดโน้ต', textbook_ref: 'JN60101 Ch.2 p.44' },
  { id: 'c2_37', chapter_number: 2, category: 'katakana', word_romaji: 'kādo', word_kana: 'カード', word_kanji: null, meaning_th: 'การ์ด / บัตร', example_jp: 'Kore wa kādo desu.', example_th: 'นี่คือการ์ด', textbook_ref: 'JN60101 Ch.2 p.45' },
  { id: 'c2_38', chapter_number: 2, category: 'katakana', word_romaji: 'terehon kādo', word_kana: 'テレホンカード', word_kanji: null, meaning_th: 'บัตรโทรศัพท์ (สมัยก่อน)', example_jp: 'Kore wa terehon kādo desu.', example_th: 'นี่คือบัตรโทรศัพท์', textbook_ref: 'JN60101 Ch.2 p.46' },
  { id: 'c2_39', chapter_number: 2, category: 'katakana', word_romaji: 'bōrupen', word_kana: 'ボールペン', word_kanji: null, meaning_th: 'ปากกาลูกลื่น', example_jp: 'Kore wa bōrupen desu.', example_th: 'นี่คือปากกาลูกลื่น', textbook_ref: 'JN60101 Ch.2 p.47' },
  { id: 'c2_40', chapter_number: 2, category: 'katakana', word_romaji: 'shāpu penshiru', word_kana: 'シャープペンシル', word_kanji: null, meaning_th: 'ดินสอกด', example_jp: 'Kore wa shāpu penshiru desu.', example_th: 'นี่คือดินสอกด', textbook_ref: 'JN60101 Ch.2 p.48' },
  { id: 'c2_41', chapter_number: 2, category: 'katakana', word_romaji: 'terebi', word_kana: 'テレビ', word_kanji: null, meaning_th: 'โทรทัศน์ / ทีวี', example_jp: 'Kore wa terebi desu.', example_th: 'นี่คือโทรทัศน์', textbook_ref: 'JN60101 Ch.2 p.49' },
  { id: 'c2_42', chapter_number: 2, category: 'katakana', word_romaji: 'rajio', word_kana: 'ラジオ', word_kanji: null, meaning_th: 'วิทยุ', example_jp: 'Kore wa rajio desu.', example_th: 'นี่คือวิทยุ', textbook_ref: 'JN60101 Ch.2 p.50' },
  { id: 'c2_43', chapter_number: 2, category: 'katakana', word_romaji: 'kamera', word_kana: 'カメラ', word_kanji: null, meaning_th: 'กล้องถ่ายรูป', example_jp: 'Kore wa kamera desu.', example_th: 'นี่คือกล้องถ่ายรูป', textbook_ref: 'JN60101 Ch.2 p.51' },
  { id: 'c2_44', chapter_number: 2, category: 'katakana', word_romaji: 'konpyūtā', word_kana: 'コンピューター', word_kanji: null, meaning_th: 'คอมพิวเตอร์', example_jp: 'Kore wa konpyūtā desu.', example_th: 'นี่คือคอมพิวเตอร์', textbook_ref: 'JN60101 Ch.2 p.52' },
  { id: 'c2_45', chapter_number: 2, category: 'katakana', word_romaji: 'chokorēto', word_kana: 'チョコレート', word_kanji: null, meaning_th: 'ช็อกโกแลต', example_jp: 'Kore wa chokorēto desu.', example_th: 'นี่คือช็อกโกแลต', textbook_ref: 'JN60101 Ch.2 p.53' },
  { id: 'c2_46', chapter_number: 2, category: 'katakana', word_romaji: 'kōhī', word_kana: 'コーヒー', word_kanji: null, meaning_th: 'กาแฟ', example_jp: 'Kore wa kōhī desu.', example_th: 'นี่คือกาแฟ', textbook_ref: 'JN60101 Ch.2 p.54' },
