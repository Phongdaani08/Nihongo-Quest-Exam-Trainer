...
export const AnalyticsDashboard: React.FC = () => {
      ...
      series: [
        {
          ...
          lineStyle: { width: 3 },
          areaStyle: isBar ? undefined : { color: 'rgba(2, 132, 199, 0.08)' },
  ...
  const getChart2Option = () => {
    ...
    if (chart2Type === 'bar') {
      return {
        ...
        yAxis: { type: 'value', max: 5, splitLine: { lineStyle: { type: 'dashed', color: '#f1f5f9' } } },
        series: [
          {
            name: 'คะแนนเฉลี่ย',
            type: 'bar',
            ...
            label: { show: chart2Labels, position: 'top', fontWeight: 700 },
          },
        ],
      };
    }
    ...
    if (chart2Type === 'polar') {
      return {
        ...
        polar: { radius: [20, '75%'] },
        angleAxis: { max: 5, startAngle: 75, splitLine: { lineStyle: { color: '#f1f5f9' } } },
        radiusAxis: {
          type: 'category',
          data: ['ส่วนที่ 1 (Jiko)', 'ส่วนที่ 2 (Speed)', 'ส่วนที่ 3 (Visual)'],
  ...
  const getChart3Option = () => {
    ...
    if (chart3Type === 'line') {
      return {
        ...
        grid: { left: '3%', right: '4%', bottom: '3%', top: '20px', containLabel: true },
        xAxis: { type: 'category', data: categories, axisLabel: { interval: 0, rotate: 20, fontSize: 10, color: '#64748b' } },
        ...
        series: [
          {
            ...
            label: { show: chart3Labels, position: 'top', formatter: '{c}%', fontWeight: 700 },
          },
        ],
      };
    }
    ...
    if (chart3Type === 'vertical_bar') {
      return {
        ...
        xAxis: { type: 'category', data: categories, axisLabel: { interval: 0, rotate: 25, fontSize: 10, color: '#64748b' } },
        yAxis: { type: 'value', max: 100, axisLabel: { formatter: '{value}%' }, splitLine: { lineStyle: { type: 'dashed', color: '#f1f5f9' } } },
        series: [
          {
            type: 'bar',
      ...
      series: [
        {
          ...
          label: { show: chart3Labels, position: 'right', formatter: '{c}%', fontWeight: 700, fontSize: 11 },
        },
      ],
    };
  };
  ...
  const getChart5Option = () => {
    ...
    if (chart5Type === 'bar') {
      return {
        tooltip: { trigger: 'axis', formatter: '{b}: {c} วินาที' },
        ...
        yAxis: { type: 'value', max: 180, axisLabel: { formatter: '{value}s' }, splitLine: { lineStyle: { type: 'dashed', color: '#f1f5f9' } } },
        series: [
          {
            type: 'bar',
            data: durations,
            itemStyle: { color: '#f59e0b', borderRadius: [4, 4, 0, 0] },
            label: { show: chart5Labels, position: 'top', formatter: '{c}s', fontWeight: 700 },
            markLine: {
    ...
    if (chart5Type === 'scatter') {
      return {
        tooltip: { trigger: 'item', formatter: '{b}: {c} วินาที' },
        grid: { left: '3%', right: '4%', bottom: '3%', top: '25px', containLabel: true },
        xAxis: { type: 'category', data: categories, axisLabel: { color: '#64748b', fontSize: 11 } },
        yAxis: { type: 'value', max: 180, axisLabel: { formatter: '{value}s' }, splitLine: { lineStyle: { type: 'dashed', color: '#f1f5f9' } } },
        series: [
    ...
    // Default: Area Chart
    return {
      tooltip: { trigger: 'axis', formatter: '{b}: <strong>{c} วินาที</strong>' },
      grid: { left: '3%', right: '4%', bottom: '3%', top: '25px', containLabel: true },
      xAxis: {
        type: 'category',
        data: categories,
      ...
      yAxis: {
        type: 'value',
        max: 180,
        axisLabel: { formatter: '{value}s', color: '#64748b', fontSize: 11 },
        splitLine: { lineStyle: { type: 'dashed', color: '#f1f5f9' } },
      },
      series: [
        {
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
      ...
      >
        <div>
          ...
          <h2 style={{ fontSize: '22px', fontWeight: 800 }}>Analytics & Examination Performance Dashboard</h2>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          {refreshInterval > 0 && (
            <span style={{ fontSize: '12px', color: 'var(--primary-700)', fontWeight: 700 }}>
              (อีก {countdown}s)
            </span>
          )}
      ...
      {stats && (
        ...
        >
          ...
          <div className="card" style={{ padding: '16px 20px', backgroundColor: '#ffffff' }}>
            ...
            <div style={{ fontSize: '26px', fontWeight: 800, color: stats.passRate >= 75 ? '#16a34a' : '#ea580c', marginTop: '4px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(460px, 1fr))', gap: '20px' }}>
        ...
        <div className="card" style={{ padding: '20px', backgroundColor: '#ffffff' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '14px', flexWrap: 'wrap', gap: '8px' }}>
            <div>
              <h3 style={{ fontSize: '16px', fontWeight: 700 }}>แนวโน้มคะแนนสอบสะสม (Score Progression)</h3>
        ...
        <div className="card" style={{ padding: '20px', backgroundColor: '#ffffff' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '14px', flexWrap: 'wrap', gap: '8px' }}>
            <div>
              <h3 style={{ fontSize: '16px', fontWeight: 700 }}>ระดับสมรรถนะรายทักษะ (Section Competency)</h3>
        ...
        <div className="card" style={{ padding: '20px', backgroundColor: '#ffffff' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '14px', flexWrap: 'wrap', gap: '8px' }}>
            <div>
              <h3 style={{ fontSize: '16px', fontWeight: 700 }}>ความแม่นยำตามหมวดเนื้อหา (Category Accuracy)</h3>
        ...
        <div className="card" style={{ padding: '20px', backgroundColor: '#ffffff' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '14px', flexWrap: 'wrap', gap: '8px' }}>
            <div>
              <h3 style={{ fontSize: '16px', fontWeight: 700 }}>สัดส่วนระดับผลการสอบ (Grade Distribution)</h3>
        ...
        <div className="card" style={{ padding: '20px', backgroundColor: '#ffffff', gridColumn: '1 / -1' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '14px', flexWrap: 'wrap', gap: '8px' }}>
            <div>
              <h3 style={{ fontSize: '16px', fontWeight: 700 }}>ระยะเวลาที่ใช้ในการสอบ (Duration vs 180s Benchmark)</h3>
      ...
      <div className="card" style={{ padding: '24px', backgroundColor: '#ffffff' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
          <div>
            <h3 style={{ fontSize: '18px', fontWeight: 800 }}>บันทึกประวัติการสอบล่าสุด (Exam Sessions Log)</h3>
                ...
                recentSessions.slice(0, 15).map((s, idx) => {
                  ...
                  return (
                    <tr key={s.id || idx} style={{ borderBottom: '1px solid var(--border-subtle)' }}>
                      ...
                      <td style={{ padding: '12px 14px' }}>{s.student_name || 'Poom'}</td>
                      <td style={{ padding: '12px 14px' }}>{s.total_duration_seconds} วินาที</td>
                      <td style={{ padding: '12px 14px' }}>{s.score_section_1} / 5</td>
                      <td style={{ padding: '12px 14px' }}>{s.score_section_2} / 5</td>
                      <td style={{ padding: '12px 14px' }}>{s.score_section_3} / 5</td>
